/**
 * Modification Author:    Raimondas Pomarnacki
 * Created:   2023-08-08
 *
 * (c) Copyright by Raimondas Pomarnacki.
 **/
...
void ST7789_Select(void) {
			...
			//-- если захотим переделать под CMSIS  ---------------
				...
				ST7789_CS_GPIO_Port->BSRR = ( ST7789_CS_Pin << 16 );
			#endif
			//-----------------------------------------------------
	#endif
...
void ST7789_Unselect(void) {
			...
			//-- если захотим переделать под CMSIS  ---------------
			#ifdef ST7789_SPI_CMSIS
				ST7789_CS_GPIO_Port->BSRR = ST7789_CS_Pin;
			#endif
			//-----------------------------------------------------
...
__inline void ST7789_SendCmd(uint8_t Cmd){	
	...
	//-- если захотим переделать под CMSIS  ---------------------------------------------
		...
		// pin DC LOW
		 ST7789_DC_GPIO_Port->BSRR = ( ST7789_DC_Pin << 16 );
...
*/		//================================================================================
		...
		// pin DC HIGH
		ST7789_DC_GPIO_Port->BSRR = ST7789_DC_Pin;
...
uint16_t buff_frame[ST7789_WIDTH*ST7789_HEIGHT];
...
/************************ (C) COPYRIGHT Raimondas Pomarnacki *****END OF FILE****/
